...
2026-07-17 版本标题为“炉痕地牢 · 三层远征”。该地址无需登录 GitHub，手机浏览器可直接打开。

本次 PVE 重构：删除自由铸卡，地图扩展为 3 层 15 房间；战斗改为击杀制，加入抽牌/弃牌/洗牌循环、10 件遗物、扇形手牌、战斗背景与地牢地图背景。旧的未完成远征会因存档版本升级自动清除一次。
